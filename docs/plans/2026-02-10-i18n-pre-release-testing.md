...
**Files:**
- Test: `tests-auto/i18n.static.spec.js`
- Test: `tests-auto/i18n.spec.js`
...
Run: `npx playwright test tests-auto/i18n.spec.js --workers=1`
Expected: 中文/英文文案断言通过，导出字段维持 `url/title/created_at`。

### Task 3: 全量回归验证

**Files:**
- Test: `tests-auto/sidepanel.spec.js`
- Test: `tests-auto/sidepanel_v1.0.0.spec.js`
- Test: `tests-auto/generate-icons.spec.js`
- Test: `tests-auto/generate-store-assets.spec.js`
